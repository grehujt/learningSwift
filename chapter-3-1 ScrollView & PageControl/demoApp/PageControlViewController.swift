...
class PageControlViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        pageControl.addTarget(self, action: #selector(PageControlViewController.pageControlDidChanged(_:)), forControlEvents: .ValueChanged)
    ...
    func pageControlDidChanged(sender:AnyObject) {
        print("call pageControlDidChanged")
    ...
    func scrollViewDidScroll(scrollView: UIScrollView) {
        print("call scrollViewDidScroll")
    ...
    func scrollViewWillBeginDecelerating(scrollView: UIScrollView) {
        print("call scrollViewWillBeginDecelerating")
